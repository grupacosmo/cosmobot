Shader "Unlit/CavityShaderT5"
{
    Properties
    {
        ...
        _DepthTreshold ("Depth Edge Treshold", Range(0.001, 1)) = 0.001
        _NormalTreshold ("Normal Edge Treshold", Range(0.001, 1)) = 0.01
        _Size ("Size", Range(0, 2)) = 1
        _FalloffTreshold ("Falloff Treshold", Range(0, 100)) = 10
        _FalloffSpeed ("Falloff Speed", Range(0.001, 0.1)) = 0.05
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag (v2f i) : SV_Target
            {
                ...
                col.a *= _Color.a;
                float falloff =  _FalloffSpeed * (dist - _FalloffTreshold);
                col.a *= clamp(1 - falloff, 0, 1);
                return col;
            }
            ENDHLSL
        }
