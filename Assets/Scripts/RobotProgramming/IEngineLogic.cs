...
namespace Cosmobot
{
    ...
    public interface IEngineLogic
    {
        ...
        ///   <see cref="Wrapper"/> class to wrap the functions, as it handles synchronization with the Unity thread
        ///   </item>
        /// </list>
        /// </summary>
        ...
        ///
        /// It is the best place to initialize the <see cref="Wrapper"/> class, which will be used in <see cref="GetFunctions"/>
        /// </summary>
